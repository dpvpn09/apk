...
echo -e " © Recode By My Self Kangsantri${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/dpvpn09/apk/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/dpvpn09/apk/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Tikusmerdeka/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Tikusmerdeka/vip/main/"
...
wget https://raw.githubusercontent.com/Kangsantri123/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
port 587
auth on
user santremuhammadfaruk@gmail.com
from santremuhammadfaruk@gmail.com
